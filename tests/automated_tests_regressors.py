...
import tests.classifiers as classifier_tests
...
test_names = OrderedDict([
    ...
    # ('feature_learning_categorical_ensembling_getting_single_predictions_regression',regressor_tests.feature_learning_categorical_ensembling_getting_single_predictions_regression_)
])
